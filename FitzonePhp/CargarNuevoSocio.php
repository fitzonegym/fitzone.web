    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Cargar Nuevo Socio</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card-body">
                  ...
                  <form class="row g-3 ">
                    <div class="col-6 text-center">
                        <label for="selector" class="form-label">Nombre (*)</label>
                    ...
                    <div class="col-6 text-center">
                        <label for="año" class="form-label">D.N.I (*)</label>
                        <input type="text" class="form-control" id="Dni" name="Dni" value=" ">
                    </div>
                    
                    <div class="col-6 text-center">
                        <label for="patente" class="form-label">Email (*)</label>
                        <input type="email" class="form-control" id="Email" name="Email" value=" ">
                    </div>
                    <div class="col-6 text-center">
                        <label for="patente" class="form-label">Telefono (*)</label>
                        <input type="text" class="form-control" id="Telefono" name="Telefono" value=" ">
                    </div>
                    <div class="col-6 text-center">
                        <label for="patente" class="form-label">Direccion (*)</label>
...
-->
                    ...
                    <div class="text-center">
                        <button class="btn btn-primary m-2" value="Login" name="BotonRegistrar" type="Submit">Registrar</button>
                        <button type="reset" class="btn btn-secondary m-2" name="BotonLimpiar" value="Limpio">Limpiar Campos</button>
                        <a href="inde.php" class="text-primary fw-bold m-2">Volver al index</a>
                    </div>
                  </form><!-- Vertical Form -->
